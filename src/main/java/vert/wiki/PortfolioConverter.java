...
/**
 * Converter for {@link vert.wiki.Portfolio}.
 * <p>
 * NOTE: This class has been automatically generated from the {@link vert.wiki.Portfolio} original class using Vert.x codegen.
 */
public class PortfolioConverter {
    ...
    public static void fromJson(JsonObject json, Portfolio obj) {
        ...
        obj.setDate((json.getInstant("date")));
