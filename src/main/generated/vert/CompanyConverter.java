...
public class CompanyConverter {
  ...
  public static void fromJson(JsonObject json, Company obj) {
    ...
    if (json.getValue("companyNo") instanceof String) {
      obj.setCompanyNo((String)json.getValue("companyNo"));
    }
  ...
  public static void toJson(Company obj, JsonObject json) {
    ...
    if (obj.getCompanyNo() != null) {
      json.put("companyNo", obj.getCompanyNo());
    }
