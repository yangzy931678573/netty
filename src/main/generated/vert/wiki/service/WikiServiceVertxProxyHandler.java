...
import vert.wiki.service.WikiService;
...
public class WikiServiceVertxProxyHandler extends ProxyHandler {
  ...
  public WikiServiceVertxProxyHandler(Vertx vertx, WikiService service) {
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public WikiServiceVertxProxyHandler(Vertx vertx, WikiService service, long timeoutInSecond) {
    this(vertx, service, true, timeoutInSecond);
  }

  public WikiServiceVertxProxyHandler(Vertx vertx, WikiService service, boolean topLevel, long timeoutSeconds) {
    this.vertx = vertx;
