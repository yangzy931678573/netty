...
public class WikiServiceVertxEBProxy implements WikiService {
  ...
  public WikiServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public WikiServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
